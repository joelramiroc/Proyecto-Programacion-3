...
WithMovimentsNormal::WithMovimentsNormal(map<string,sf::Drawable*>& drawables, Cube* &cube,Window& window_,string nombrePlayer):window_(window_)
{
...
void WithMovimentsNormal::comparations()
{
...
void WithMovimentsNormal::update()
{
...
void WithMovimentsNormal::info()
{
    Dispon--;
    cantidadRestante = "Disponibles: " + to_string(Dispon);
};

void WithMovimentsNormal::events()
{
...
void WithMovimentsNormal::cleared()
{
    window_.close();
}

void WithMovimentsNormal::loop()
{
    scramble();
    while(repetir)
    {
